...
import com.example.intern_assignment.auth.entity.AuthUser;
...
public class AdminController {
    ...
    @Operation(summary = "관리자만 실행가능한 API", description = "사용자가 관리자 권한을 가지고 있는지 확인하는 API입니다.")
    @GetMapping()
    public ResponseEntity<Void> verifyAdmin(@AuthenticationPrincipal AuthUser authUser) {
